...
largest nuclear power station in the United States \cite{durand_truth,nrc_ml25051}.
It is the only site in the country
...
project management \cite{durand_truth}.
...
of \$660 million to a final cost of \$8.8 billion \cite{schlissel_ieefa}. Despite this precedent, Georgia Power
...
new AP1000 passive-safety reactor design \cite{schlissel_ieefa,gpsc_2008}.
...
cost than prior nuclear builds \cite{schlissel_ieefa,gpsc_2008}. This claim proved to be significantly overstated \cite{schlissel_ieefa}.
...
in 1987 and 1989---an overrun exceeding 1,200\% \cite{schlissel_ieefa}. A U.S. Department of Energy
study of 75 reactors built between 1966 and 1977 found average construction costs
ran 207\% over initial estimates \cite{doe_eia0485,schlissel_ieefa}. The historical record provided ample evidence that
...
seeking certification in 2008 \cite{schlissel_ieefa,gpsc_2008}:
...
Both units entered commercial operation more than \textbf{six years behind schedule} \cite{schlissel_ieefa}.
...
\begin{itemize}
    \item Southern Nuclear Operating Company received no NRC Notices of Violation
          ...
          under the NRC's Construction Reactor Oversight Process (cROP) \cite{vcm_report}.
    \item The site sustained more than \textbf{34 million man-hours} without a lost-time
          incident before an incident occurred in April 2020 \cite{vcm_report}.
    \item The \textbf{COVID-19 pandemic} caused significant workforce disruptions in
          ...
          reductions, and increased costs and productivity challenges \cite{vcm_report}.
    \item Despite pandemic-related setbacks, essential construction activities including
          ...
          Shield Building continued \cite{vcm_report}.
\end{itemize}
...
engineering, procurement, and construction \cite{durand_truth,gcv_ratepayer}. The bankruptcy was triggered in part by
...
in July 2017 following nine consecutive rate increases \cite{durand_truth}. Investigations revealed that
Westinghouse and utility executives had misrepresented project progress and costs,
ultimately resulting in criminal charges and jail time for two SCANA executives \cite{durand_truth}.

In Georgia, the PSC voted to continue the Vogtle project despite the Westinghouse
bankruptcy, without imposing meaningful consumer protections against further overruns \cite{gcv_ratepayer,durand_truth}.
...
power plant ever built on Earth at the time of its completion \cite{gcv_ratepayer,schlissel_ieefa}.
...
2,200 MW of generating capacity \cite{gcv_ratepayer}.
...
a plant enters commercial operation \cite{gcv_ratepayer}. The NCCR tariff allowed Georgia Power to
collect revenues from customers throughout the construction period, effectively
shifting financial risk from shareholders to ratepayers \cite{gcv_ratepayer}. Between 2009 and 2021,
Georgia Power collected multiple NCCR-based rate increases from its customers \cite{gcv_ratepayer}.
...
one of the \textbf{highest returns on equity (ROE)} of any utility in the United States \cite{gcv_ratepayer}.
...
guaranteed rate of return \cite{gcv_ratepayer}. This created a perverse incentive that contributed to
...
interests of the industry it regulates rather than the public \cite{gcv_ratepayer,durand_truth}. Georgia Power itself
referred to this relationship as ``constructive regulation'' \cite{gcv_ratepayer}.

\subsection{Key PSC Decisions}

\begin{itemize}
    \item \textbf{March 2009}: Approved Georgia Power's application to build Units 3 and 4 \cite{gpsc_2008,schlissel_ieefa}.
    \item \textbf{2017}: Voted to continue construction despite Westinghouse bankruptcy and
          available cancellation option; declined to impose consumer protections \cite{gcv_ratepayer,durand_truth}.
    \item \textbf{December 2023}: Final PSC vote following completion of the project, amid
          ongoing protests from ratepayer advocacy groups \cite{durand_truth}.
\end{itemize}
...
NRC performance indicator throughout 2020 \cite{vcm_report}.
...
national reactor registry \cite{nrc_ml25051}.
...
in the United States has been associated with dramatic cost overruns \cite{schlissel_ieefa,gcv_ratepayer,durand_truth}. From Vogtle
Units 1 \& 2 in the 1980s to Units 3 \& 4 in the 2010s--2020s, and across other
projects documented by the DOE and NRC \cite{doe_eia0485}, cost escalation appears to be a structural
feature of nuclear construction rather than an anomaly.

\subsection{Theme 2: Regulatory Capture and Ratepayer Risk}

Multiple reports identify a pattern of regulatory capture at the Georgia PSC \cite{gcv_ratepayer,durand_truth,schlissel_ieefa}. The
...
control \cite{gcv_ratepayer}. The PSC's failure to impose consumer protections following the Westinghouse
bankruptcy in 2017 is highlighted by all three independent studies as a critical
governance failure \cite{gcv_ratepayer,durand_truth,schlissel_ieefa}.
...
throughout the advocacy reports \cite{durand_truth,gcv_ratepayer}. Had Georgia followed South Carolina's decision to
...
Georgia---is cited as evidence of differential regulatory enforcement \cite{durand_truth}.
...
nuclear policy discussions in other states \cite{kentucky_sjr79}. The report's cautious framing of SMRs
...
committing to large capital expenditures \cite{kentucky_sjr79}.
...
vulnerability of large construction projects to workforce disruptions \cite{vcm_report}. The virus
caused schedule delays and cost increases at Vogtle, adding to an already troubled
project \cite{vcm_report}. This experience points to the need for resilient workforce planning and
...
reactors built in the country in over 30 years \cite{durand_truth}, they have served as both an ambition
...
\begin{enumerate}
    \item \textbf{Cost overruns were predictable.} Historical data from Vogtle 1 \& 2
          ...
          estimate was unrealistic \cite{schlissel_ieefa,doe_eia0485}. The project ultimately cost more than double that amount \cite{gcv_ratepayer,schlissel_ieefa}.

    \item \textbf{Regulatory oversight failed ratepayers.} The Georgia PSC, functioning
          under a model critics describe as regulatory capture \cite{gcv_ratepayer,durand_truth}, repeatedly made decisions
          that protected utility profits over consumer interests---most critically in 2017
          when the Westinghouse bankruptcy created a legitimate off-ramp \cite{gcv_ratepayer,durand_truth,schlissel_ieefa}.
    ...
    \item \textbf{The financial burden fell on ratepayers.} Through the NCCR tariff and
          ...
          construction and will continue to pay elevated rates for decades \cite{gcv_ratepayer}.
    ...
    \item \textbf{Alternatives existed and were not chosen.} Multiple analyses demonstrate
          ...
          in solar and wind between 2009 and 2023 \cite{gcv_ratepayer,durand_truth}.
    ...
    \item \textbf{Vogtle is now shaping national nuclear policy.} The project's completion,
          ...
          through phased approaches and SMR technology \cite{kentucky_sjr79}.
\end{enumerate}
...
\bibitem{durand_truth}
Durand, P., Scott, K., \& Carroll, G. (n.d.).
\textit{The Truth About Vogtle}.
Sponsored by Cool Planet Solutions, Georgia WAND, Nuclear Watch South,
GCV Education Fund, Center for a Sustainable Coast, Concerned Ratepayers
of Georgia.

\bibitem{gcv_ratepayer}
Georgia Conservation Voters \& Environment Georgia. (December 2021).
\textit{Ratepayer Robbery --- The True Cost of Plant Vogtle}.

\bibitem{schlissel_ieefa}
Schlissel, D. (January 2022).
\textit{Southern Company's Troubled Vogtle Nuclear Project: Units 3 and 4
Now Expected to Cost More Than \$30 Billion and Are at Least Six Years
Behind Schedule}.
Institute for Energy Economics and Financial Analysis (IEEFA).

\bibitem{vcm_report}
Georgia Power Company / Southern Nuclear Operating Company. (August 2020).
...
\bibitem{kentucky_sjr79}
Kentucky Office of Energy Policy. (November 17, 2023).
\textit{Final Report SJR 79: Report to the Kentucky Legislative Research
Commission Pursuant to 2023RS SJR 79}.

\bibitem{nrc_ml25051}
U.S.\ Nuclear Regulatory Commission. (2025).
\textit{Commercial Nuclear Power Reactors: Operating Reactors, Appendix A}.
NRC Document ML25051A096.

\bibitem{doe_eia0485}
U.S.\ Energy Information Administration. (January 1, 1986).
\textit{An Analysis of Nuclear Power Plant Construction Costs}.
Technical Report DOE/EIA-0485.

\bibitem{gpsc_2008}
Georgia Public Service Commission. (August 1, 2008).
\textit{Georgia Power Company Application for the Certification of Vogtle
Generating Units 3 and 4 and Upgraded Integrated Resource Plan}.
